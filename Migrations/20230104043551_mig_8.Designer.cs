...
namespace VacationManagementSystem.Migrations
{
    ...
    [Migration("20230104043551_mig_8")]
    partial class mig_8
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacationManagementSystem.Models.HotelTicket", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VacationManagementSystem.Models.TourTicket", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VacationManagementSystem.Models.HotelTicket", b =>
                {
                    ...
                    b.HasOne("VacationManagementSystem.Models.Room", "room")
                        .WithMany()
            ...
            modelBuilder.Entity("VacationManagementSystem.Models.TourTicket", b =>
                {
                    ...
                    b.HasOne("VacationManagementSystem.Models.Tour", "Tour")
                        .WithMany()
